...
bool Battle1 (short mcHp, short mcStr, short mcMag, float mcCrit){
    ...
    cin>>Cmd;
        ...
        if(pHp<=0){
            ...
            cout<<"Rock Candy Golem dropped 1043 gold"<<endl;
            cout<<"Continue..."<<endl;
            Continu ();   
        }
...
unsigned short Poison (short curPois){
    ...
    for (counter1=1;counter1<=curPois;counter1++){
...
short Battle2 (short mcHp, short mcStr, short mcMag, float mcCrit){
    ...
    short gHp=150;                  //Statistics of enemy
    unsigned short gStr=8;
    ...
    do{
        ...
        //Signals for when the player is defeated
        if(mcHp<=0){
            cout<<"You just got defeated by the Rock Candy Golem"<<endl;
            cout<<"It swings again and knocks you out"<<endl;
            cout<<"Continue..."<<endl;
            Continu ();
            cout<<"The Rock Candy Golem takes your lunch money and  you skulk\n";
            cout<<"into the sunset. You cease your adventures as a candy making explorer"<<endl;
            cout<<"and go to work in the Chocolate Mines for minimum wage"<<endl;
            cout<<"...for the rest of your life"<<endl;
            cout<<endl;
    ...
    cin>>Cmd;
        ...
        switch (Cmd){
            ...
            case '2':
                ...
                switch (ablMenu){
                        ...
                        cout<<"You focus on hitting a weak point\n";
                        cout<<"The pudding has "<<endl;
                        cout<<(gHp-=CritRt((rand()%14+1),50))<<endl;
                        cout<<" health left."<<endl;
                        ablSlct++;
                        break;
        ...
        //Calculates and tracks damage to user when enemy attacks
         cout<<"The Rock Candy Golem strikes you!"<<endl;
         cout<<"You have "<<(mcHp-=(rand()%19+1)+gStr)<<" left"<<endl;
         cout<<endl;   
...
short FBattle (short, short, short, float){
